...
| 2 | [Meet the Robot](02-meet-the-robot.md) | Parts, cables, kill switch, the things you need to find |
...
| 5 | [Tablet & Network](05-tablet-and-network.md) | Dual-network on the tablet, ADB, your laptop ↔ robot |
| 6 | [Our Software](06-our-software.md) | The tablet HTML app and the React dashboard |
| 7 | [Talking to the Robot](07-talking-to-the-robot.md) | rosbridge — topics, services, code snippets |
| 8 | [Videos](08-videos.md) | Walkthrough + vendor clips |
| 9 | [References & Files](09-references.md) | Everything in `assets/` and `report/` |
